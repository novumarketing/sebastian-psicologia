      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li>
              <a href="https://wa.me/527752142603?text=Hola%20Psic.%20Sebasti%C3%A1n%2C%20vi%20su%20sitio%20web%20y%20me%20gustar%C3%ADa%20recibir%20m%C3%A1s%20informaci%C3%B3n%20para%20agendar%20una%20consulta." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors">
            ...
            <li className="flex items-start gap-2">
              <svg className="w-4 h-4 text-primary-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 1z"/>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 1z"/>
              </svg>
              <span>Medical Center Jardines del Sur · Tulancingo<br />Hospital Intermédica · Pachuca, Hgo.</span>
            </li>
          </ul>
        </div>
      </div>
