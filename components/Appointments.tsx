    ...
    return (
      <section className="py-24 px-6 bg-white">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-slate-600 mb-6">Se abrió WhatsApp con tu solicitud. Recibirás confirmación en breve.</p>
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        <div>
          ...
          <p className="text-slate-600 leading-relaxed mb-10">
            Llena el formulario y te contactaré por WhatsApp para confirmar
            fecha, hora y consultorio. La primera sesión incluye una
            valoración inicial sin costo adicional.
          </p>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
          <form onSubmit={handleWhatsApp} className="space-y-5">
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-medium text-slate-700 mb-1.5">Teléfono / WhatsApp *</label>
              <input
            ...
            <div>
              <label htmlFor="service" className="block text-sm font-medium text-slate-700 mb-1.5">Servicio *</label>
              <select
            ...
            <div>
              <label htmlFor="location" className="block text-sm font-medium text-slate-700 mb-1.5">Consultorio preferido *</label>
              <select
              ...
              >
                ...
                <option value="Hospital Intermédica Pachuca">Hospital Intermédica Pachuca</option>
                <option value="En línea">En línea (videollamada)</option>
              </select>
            </div>

            <div>
              <label htmlFor="message" className="block text-sm font-medium text-slate-700 mb-1.5">Mensaje (opcional)</label>
              <textarea
            ...
            <button
              type="submit"
              className="w-full bg-primary-700 hover:bg-primary-800 text-white font-semibold py-4 rounded-xl transition-colors flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-300 focus-visible:ring-offset-2"
            >
            ...
            <p className="text-center text-xs text-slate-400">Se abrirá WhatsApp con tu solicitud preparada.</p>
          </form>
        </div>
      </div>
    </section>
