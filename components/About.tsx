      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          <div className="relative overflow-hidden rounded-2xl shadow-2xl aspect-[3/4] max-w-sm mx-auto lg:mx-0 bg-primary-100">
            <img
              src="/sebastian.jpg"
              alt="Mtro. C. Sebastián Escorza Reyes"
        ...
        <div>
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            Soy Mtro. C. Sebastián Escorza Reyes, psicoterapeuta especializado en <strong className="text-slate-800">Terapia Cognitivo-Conductual (TCC)</strong>, un enfoque de eficacia comprobada y respaldado por amplia evidencia científica, que complemento con herramientas de Aceptación y Compromiso (ACC).
          </p>
